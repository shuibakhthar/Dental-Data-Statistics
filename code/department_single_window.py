...
#    Mar 07, 2020 03:52:30 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    department_single_window_support.set_Tk_var()
    top = Department_Single_Window (root)
    department_single_window_support.init(root, top)
    root.mainloop()

w = None
def create_Department_Single_Window(root, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = tk.Toplevel (root)
    department_single_window_support.set_Tk_var()
    top = Department_Single_Window (w)
    department_single_window_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_Department_Single_Window():
    global w
    w.destroy()
    w = None

class Department_Single_Window:

    def __init__(self, Department_Single_Window=None):
        '''This class configures and populates the toplevel window.
                   Department_Single_Window is the toplevel containing window.'''
        ...
        Department_Single_Window.geometry("1491x739+35+31")
        Department_Single_Window.minsize(148, 1)
        Department_Single_Window.maxsize(4112, 1030)
        Department_Single_Window.resizable(1, 1)
        Department_Single_Window.title("DEPARTMENT OUT-PATIENT")
        Department_Single_Window.configure(background="#40b3a3")
        Department_Single_Window.configure(highlightbackground="#d9d9d9")
        Department_Single_Window.configure(highlightcolor="black")

        self.menubar = tk.Menu(Department_Single_Window, font=font9, bg=_bgcolor, fg=_fgcolor)
        Department_Single_Window.configure(menu=self.menubar)

        self.File = tk.Menu(Department_Single_Window, tearoff=0)
        ...
        self.File.add_command(
            ...
            foreground="#000000",
            label="Exit",
            command=department_single_window_support.destroy_window)

        self.Department_Label = tk.Label(Department_Single_Window)
        ...
        self.Old_Patient_Radio = tk.Radiobutton(Department_Single_Window)
        self.Old_Patient_Radio.place(relx=0.013, rely=0.124, relheight=0.042, relwidth=0.10)
        ...
        self.Old_Patient_Label = tk.Label(Department_Single_Window)
        self.Old_Patient_Label.place(relx=0.12, rely=0.124, relheight=0.042, relwidth=0.08)
        self.Old_Patient_Label.configure(background="#40b3a3")
        self.Old_Patient_Label.configure(disabledforeground="#a3a3a3")
        self.Old_Patient_Label.configure(font="-family {Helvetica} -size 10")
        self.Old_Patient_Label.configure(foreground="#000000")
        self.Old_Patient_Label.configure(highlightbackground="#d9d9d9")
        self.Old_Patient_Label.configure(highlightcolor="black")
        self.Old_Patient_Label.configure(relief="groove")

        self.New_Patient_Radio = tk.Radiobutton(Department_Single_Window)
        self.New_Patient_Radio.place(relx=0.213, rely=0.124, relheight=0.042, relwidth=0.10)
        ...
        self.New_Patient_Label = tk.Label(Department_Single_Window)
        self.New_Patient_Label.place(relx=0.32, rely=0.124, relheight=0.042, relwidth=0.08)
        self.New_Patient_Label.configure(background="#40b3a3")
        self.New_Patient_Label.configure(disabledforeground="#a3a3a3")
        self.New_Patient_Label.configure(font="-family {Helvetica} -size 10")
        self.New_Patient_Label.configure(foreground="#000000")
        self.New_Patient_Label.configure(highlightbackground="#d9d9d9")
        self.New_Patient_Label.configure(highlightcolor="black")
        self.New_Patient_Label.configure(relief="groove")

        self.He_radio = tk.IntVar(None, 0)
        self.Health_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Health_Label = tk.Label(Department_Single_Window)
        ...
        self.Incharge_Label = tk.Label(Department_Single_Window)
        ...
        self.Incharge_Entry = tk.Entry(Department_Single_Window)
        ...
        self.Phone_Label = tk.Label(Department_Single_Window)
        ...
        self.Phone_Entry = tk.Entry(Department_Single_Window)
        ...
        self.Date_Label = tk.Label(Department_Single_Window)
        ...
        self.Date_Entry = DateEntry(Department_Single_Window, year= now.year, month= now.month, day= now.day)
        ...
        self.ID_Label = tk.Label(Department_Single_Window)
        ...
        self.ID_Entry = tk.Entry(Department_Single_Window)
        ...
        self.Patient_Name_Label = tk.Label(Department_Single_Window)
        ...
        self.Patient_Name_Entry = tk.Entry(Department_Single_Window)
        ...
        self.Patient_Phone_Label = tk.Label(Department_Single_Window)
        ...
        self.Patient_Phone_Entry = tk.Entry(Department_Single_Window)
        ...
        self.Endodontics_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Endodontics_Check.configure(variable=department_single_window_support.Endodontics)

        self.Periodont_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Periodont_Check.configure(variable=department_single_window_support.Periodont)

        self.Orthodontics_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Orthodontics_Check.configure(variable=department_single_window_support.Orthodontics)

        self.Surgery_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Surgery_Check.configure(variable=department_single_window_support.Surgery)

        self.Pedodont_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Pedodont_Check.configure(variable=department_single_window_support.Pedodont)

        self.Oralpatho_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Oralpatho_Check.configure(variable=department_single_window_support.Oralpatho)

        self.Public_Health_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Public_Health_Check.configure(variable=department_single_window_support.Public_Health)

        self.Oral_Mea_Check = tk.Checkbutton(Department_Single_Window)
        self.Oral_Mea_Check.place(relx=0.335, rely=0.514, relwidth=0.162, relheight=0.05)
        self.Oral_Mea_Check.configure(activebackground="#ececec")
        self.Oral_Mea_Check.configure(activeforeground="#000000")
        self.Oral_Mea_Check.configure(background="#d9d9d9")
        self.Oral_Mea_Check.configure(disabledforeground="#a3a3a3")
        self.Oral_Mea_Check.configure(font="-family {Helvetica} -size 13 -weight normal")
        self.Oral_Mea_Check.configure(foreground="#000000")
        self.Oral_Mea_Check.configure(highlightbackground="#d9d9d9")
        self.Oral_Mea_Check.configure(highlightcolor="black")
        self.Oral_Mea_Check.configure(justify='left')
        self.Oral_Mea_Check.configure(text='''Oral Medicine   ''')
        self.Oral_Mea_Check.configure(variable=department_single_window_support.Oral_Mea)

        self.Prostho_Check = tk.Checkbutton(Department_Single_Window)
        ...
        self.Prostho_Check.configure(variable=department_single_window_support.Prostho)

        self.Grand_Total_Label = tk.Label(Department_Single_Window)
        ...
        self.Endodontics_Label = tk.Label(Department_Single_Window)
        ...
        self.Periodont_Label = tk.Label(Department_Single_Window)
        ...
        self.Orthodontics_Label = tk.Label(Department_Single_Window)
        ...
        self.Surgery_Label = tk.Label(Department_Single_Window)
        ...
        self.Pedodont_Label = tk.Label(Department_Single_Window)
        ...
        self.Oralpatho_Label = tk.Label(Department_Single_Window)
        ...
        self.Public_Health_Label = tk.Label(Department_Single_Window)
        ...
        self.Oral_Mea_Label = tk.Label(Department_Single_Window)
        ...
        self.Prostho_Label = tk.Label(Department_Single_Window)
        ...
        self.Add_Button_ = tk.Button(Department_Single_Window)
        ...
        self.Delete_Button = tk.Button(Department_Single_Window)
        ...
        self.Update_Button = tk.Button(Department_Single_Window)
        ...
        self.Clear_Button = tk.Button(Department_Single_Window)
        ...
        self.Refresh_Button = tk.Button(Department_Single_Window)
        ...
        self.Scrolledtreeview1 = ScrolledTreeView(Department_Single_Window)
        self.Scrolledtreeview1.place(relx=0.02, rely=0.717, relheight=0.253
                                    , relwidth=0.969)
        self.Scrolledtreeview1.configure(columns=(
        "Id", "Date", "T/R/S", "OLD/NEW", "Incharge", "Phone_no", "Patient_name", "Patient_contact", "Health_education",
        ...
        self.Scrolledtreeview1.heading("OLD/NEW", text="OLD/NEW")
        self.Scrolledtreeview1.heading("OLD/NEW", anchor="center")
        self.Scrolledtreeview1.column("OLD/NEW", width="100")
        self.Scrolledtreeview1.column("OLD/NEW", minwidth="20")
        self.Scrolledtreeview1.column("OLD/NEW", stretch="1")
        self.Scrolledtreeview1.column("OLD/NEW", anchor="center")
        ...
        # self.Scrolledlistbox3 = ScrolledListBox(Department_Single_Window)
        ...
        self.Screened_Radio = tk.Radiobutton(Department_Single_Window)
        ...
        self.Screened_Label = tk.Label(Department_Single_Window)
        ...
        self.Reffered_Radio = tk.Radiobutton(Department_Single_Window)
        ...
        self.Reffered_Label = tk.Label(Department_Single_Window)
        ...
        self.Treated_Radio = tk.Radiobutton(Department_Single_Window)
        ...
        self.Treated_Label = tk.Label(Department_Single_Window)
        ...
        self.Grand_Total_Label1 = tk.Label(Department_Single_Window)
        ...
        self.Grand_Total_Label2 = tk.Label(Department_Single_Window)
    ...
    def get_entry_object(self):
        ...
        entries = [
            ...
            self.He_radio,
            department_single_window_support.Endodontics,
            department_single_window_support.Periodont,
            department_single_window_support.Orthodontics,
            department_single_window_support.Surgery,
            department_single_window_support.Pedodont,
            department_single_window_support.Oralpatho,
            department_single_window_support.Public_Health,
            department_single_window_support.Oral_Mea,
            department_single_window_support.Prostho,
            Grand_Total
        ]
        return entries
    ...
    def clear_text(self):
        entries = self.get_entry_object()
        self.He_radio.set(0)
        department_single_window_support.Endodontics.set(0)
        department_single_window_support.Periodont.set(0)
        department_single_window_support.Orthodontics.set(0)
        department_single_window_support.Surgery.set(0)
        department_single_window_support.Pedodont.set(0)
        department_single_window_support.Oralpatho.set(0)
        department_single_window_support.Public_Health.set(0)
        department_single_window_support.Oral_Mea.set(0)
        department_single_window_support.Prostho.set(0)
        for i in range(0, len(entries)):
            try:
                if i != 1:
    ...
    def remove_item(self):
        ...
        # print(new_values)
        self.data.remove("dept", new_values[0], new_values[1])
        self.populate_list()
    ...
    def populate_list(self):
        ...
        counts = self.data.get_total("dept", self.data.dept[9:], self.Date_Entry.get(), self.tr_radio.get())
        for label in range(len(label_list)):
            label_list[label].configure(text = "%d patients" %(0 if counts[label] == None else counts[label]))

        tot,h,old,new,s,r,t = self.data.dept_func(self.Date_Entry.get())
        self.Grand_Total_Label2.configure(text="%d patients" %(tot))
        self.Health_Label.configure(text="%d patients" %(h))
        self.New_Patient_Label.configure(text="%d patients " %(new))
        self.Old_Patient_Label.configure(text="%d patients " %(old))
        self.Screened_Label.configure(text="%d patients " %(s))
        self.Treated_Label.configure(text="%d patients " %(t))
        self.Reffered_Label.configure(text="%d patients " %(r))
