...
#    Mar 07, 2020 03:53:33 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    satellite_singe_window_support.set_Tk_var()
    top = Satellite_Single_Window (root)
    satellite_singe_window_support.init(root, top)
    root.mainloop()

w = None
def create_Satellite_Single_Window(root, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = tk.Toplevel (root)
    satellite_singe_window_support.set_Tk_var()
    top = Satellite_Single_Window (w)
    satellite_singe_window_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_Satellite_Single_Window():
    global w
    w.destroy()
    w = None

class Satellite_Single_Window:

    def satellite(self):
        satelite_window.create_Toplevel1(root)

    def __init__(self, Satellite_Single_Window =None):
        '''This class configures and populates the toplevel window.
                   Satellite_Single_Window is the toplevel containing window.'''
        ...
        Satellite_Single_Window.geometry("1491x739+35+31")
        Satellite_Single_Window.minsize(148, 1)
        Satellite_Single_Window.maxsize(4112, 1030)
        Satellite_Single_Window.resizable(1, 1)
        Satellite_Single_Window.title("SATELLITE OUT-PATIENT")
        Satellite_Single_Window.configure(background="#40b3a3")
        Satellite_Single_Window.configure(highlightbackground="#d9d9d9")
        Satellite_Single_Window.configure(highlightcolor="black")

        self.menubar = tk.Menu(Satellite_Single_Window, font=font9, bg=_bgcolor, fg=_fgcolor)
        Satellite_Single_Window.configure(menu=self.menubar)

        self.File = tk.Menu(Satellite_Single_Window, tearoff=0)
        ...
        self.Department_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Department_Label.configure(text='''Satellite Centre Out Patient''')

        self.center_radio = tk.IntVar(None, 1)
        # self.center_radio = department_window_support.var
        self.Centre1_Radio = tk.Radiobutton(Satellite_Single_Window)
        self.Centre1_Radio.place(relx=0.013, rely=0.135, relheight=0.042
                                 , relwidth=0.18)
        ...
        self.Centre1_Radio.configure(font="-family {Helvatica} -size 13 -weight normal")
        ...
        self.Centre2_Radio = tk.Radiobutton(Satellite_Single_Window)
        self.Centre2_Radio.place(relx=0.208, rely=0.135, relheight=0.042
                                 , relwidth=0.18)
        ...
        self.Centre2_Radio.configure(font="-family {Helvatica} -size 13 -weight normal")
        ...
        self.Centre3_Radio = tk.Radiobutton(Satellite_Single_Window)
        self.Centre3_Radio.place(relx=0.402, rely=0.135, relheight=0.042
                                 , relwidth=0.18)
        self.Centre3_Radio.configure(activebackground="#ececec",
                                     activeforeground="#000000",
                                     background="#d9d9d9",
        ...
        self.Centre4_Radio = tk.Radiobutton(Satellite_Single_Window)
        self.Centre4_Radio.place(relx=0.597, rely=0.135, relheight=0.042
                                 , relwidth=0.18)
        ...
        self.Centre4_Radio.configure(font="-family {Helvatica} -size 13 -weight normal")
        ...
        self.Incharge_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Incharge_Entry = tk.Entry(Satellite_Single_Window)
        ...
        self.Phone_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Phone_Entry = tk.Entry(Satellite_Single_Window)
        ...
        self.Date_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Date_Entry = DateEntry(Satellite_Single_Window, year=now.year, month=now.month, day=now.day)
        ...
        # self.Date_Entry = tk.Entry(Satellite_Single_Window)
        # self.Date_Entry.place(relx=0.791, rely=0.189, relheight=0.048, relwidth=0.137)
        # self.Date_Entry.configure(background="white")
        ...
        self.ID_Label = tk.Label(Satellite_Single_Window)
        ...
        self.ID_Entry = tk.Entry(Satellite_Single_Window)
        ...
        self.Patient_Name_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Patient_Name_Entry = tk.Entry(Satellite_Single_Window)
        ...
        self.Patient_Phone_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Patient_Phone_Entry = tk.Entry(Satellite_Single_Window)
        ...
        self.Endodontics_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Endodontics_Check.configure(variable=satellite_singe_window_support.Endodontics)

        self.Periodont_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Periodont_Check.configure(variable=satellite_singe_window_support.Periodont)

        self.Orthodontics_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Orthodontics_Check.configure(variable=satellite_singe_window_support.Orthodontics)

        self.Surgery_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Surgery_Check.configure(variable=satellite_singe_window_support.Surgery)

        self.Pedodont_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Pedodont_Check.configure(variable=satellite_singe_window_support.Pedodont)

        self.Oralpatho_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Oralpatho_Check.configure(variable=satellite_singe_window_support.Oralpatho)

        self.Public_Health_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Public_Health_Check.configure(variable=satellite_singe_window_support.Public_Health)

        self.Oral_Mea_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Oral_Mea_Check.configure(variable=satellite_singe_window_support.Oral_Mea)

        self.Prostho_Check = tk.Checkbutton(Satellite_Single_Window)
        ...
        self.Prostho_Check.configure(variable=satellite_singe_window_support.Prostho)

        self.Grand_Total_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Endodontics_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Periodont_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Orthodontics_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Surgery_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Pedodont_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Oralpatho_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Public_Health_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Oral_Mea_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Prostho_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Add_Button_ = tk.Button(Satellite_Single_Window)
        ...
        self.Delete_Button = tk.Button(Satellite_Single_Window)
        ...
        self.Update_Button = tk.Button(Satellite_Single_Window)
        ...
        self.Clear_Button = tk.Button(Satellite_Single_Window)
        ...
        self.Refresh_Button = tk.Button(Satellite_Single_Window)
        ...
        self.Scrolledtreeview1 = ScrolledTreeView(Satellite_Single_Window)
        self.Scrolledtreeview1.place(relx=0.02, rely=0.717, relheight=0.253
                                     , relwidth=0.969)
        self.Scrolledtreeview1.configure(columns=(
            "Id", "Date", "T/R/S", "Place", "Incharge", "Phone_no", "Patient_name", "Patient_contact",
        ...
        # self.Scrolledlistbox3 = ScrolledListBox(Satellite_Single_Window)
        ...
        self.Screened_Radio = tk.Radiobutton(Satellite_Single_Window)
        ...
        self.Screened_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Reffered_Radio = tk.Radiobutton(Satellite_Single_Window)
        ...
        self.Reffered_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Treated_Radio = tk.Radiobutton(Satellite_Single_Window)
        ...
        self.Treated_Label = tk.Label(Satellite_Single_Window)
        ...
        self.Grand_Total_Label1 = tk.Label(Satellite_Single_Window)
        ...
        self.Grand_Total_Label2 = tk.Label(Satellite_Single_Window)
    ...
    def get_entry_object(self):
        ...
        entries = [
            ...
            satellite_singe_window_support.Endodontics,
            satellite_singe_window_support.Periodont,
            satellite_singe_window_support.Orthodontics,
            satellite_singe_window_support.Surgery,
            satellite_singe_window_support.Pedodont,
            satellite_singe_window_support.Oralpatho,
            satellite_singe_window_support.Public_Health,
            satellite_singe_window_support.Oral_Mea,
            satellite_singe_window_support.Prostho,
            Grand_total
        ]
        return entries
    ...
    def add_item(self):
        ...
        if (self.Date_Entry.get() == '' or self.ID_Entry.get() == '' or self.Incharge_Entry.get()=='' or self.Phone_Entry.get()=='' or self.Patient_Name_Entry.get()==''):
            ...
            # print(entries)
            self.data.insert("satellite", entries)
            self.clear_text()
            self.populate_list()
            print("1 row added")
    ...
    def clear_text(self):
        entries = self.get_entry_object()
        # self.He_radio.set(0)
        satellite_singe_window_support.Endodontics.set(0)
        satellite_singe_window_support.Periodont.set(0)
        satellite_singe_window_support.Orthodontics.set(0)
        satellite_singe_window_support.Surgery.set(0)
        satellite_singe_window_support.Pedodont.set(0)
        satellite_singe_window_support.Oralpatho.set(0)
        satellite_singe_window_support.Public_Health.set(0)
        satellite_singe_window_support.Oral_Mea.set(0)
        satellite_singe_window_support.Prostho.set(0)
        for i in range(0, len(entries)):
            try:
                if i != 1:
    ...
    def remove_item(self):
        ...
        # print(new_values)
        self.data.remove("satellite", new_values[0], new_values[1])
        self.populate_list()
    ...
    def update_item(self):
        ...
        for i in range(2,len(selected1)):
            if values[i].get()=='':
                new_values.append(selected1[i])
            else:
                new_values.append(values[i].get())
        # print(new_values)
        self.data.update("satellite", new_values)
        self.clear_text()
        self.populate_list()
    ...
    def populate_list(self):
        ...
        for row in self.data.fetch("satellite"):
        ...
        counts = self.data.get_total1("satellite", self.data.satellite[8:], self.Date_Entry.get(), self.tr_radio.get(),self.center_radio.get())
        for label in range(len(label_list)):
            label_list[label].configure(text = "%d patients" %(0 if counts[label] == None else counts[label]))

        tot, s, r, t = self.data.sat_func(self.Date_Entry.get(),self.center_radio.get())
    ...
    def satellite(self):
        try:
            satelite_window.create_Toplevel1(rt)
        except:
            satelite_window.create_Toplevel1(root)
