...
#    Feb 25, 2020 04:31:04 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    satelite_window_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    satelite_window_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, Satellite_Window=None):
        ...
        self.menubar = tk.Menu(Satellite_Window, font=font9, bg=_bgcolor, fg=_fgcolor)
        ...
        self.Department_Label.place(relx=0.201, rely=0.027, relwidth=0.518, relheight=0.084)
        ...
        self.Department_Label.configure(font="-family {Helvatica} -size 18 -weight normal")
        ...
        self.Phone_Label.configure(font="-family {Helvatica} -size 13 -weight normal")
        ...
        self.Date_Entry = DateEntry(Satellite_Window, year=now.year, month=now.month, day=now.day)
        ...
        self.Screened_Radio.place(relx=0.408, rely=0.257, relheight=0.042, relwidth=0.18)
    ...
    def remove_item(self):
        ...
        self.data.remove("satellite", selected[0])
        self.populate_list()
    ...
    def populate_list(self):
        ...
        self.count = self.data.get_count("satellite")
